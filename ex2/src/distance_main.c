...
#include <limits.h>
#include <ctype.h>
#include "distance.h"  // Assicurati che l'header distance.h contenga la dichiarazione di edit_distance_dyn
...
void find_similar_words(const char *input_word, char **dictionary, int dict_size, char **suggestions, int *suggestion_count) {
    *suggestion_count = 0;
    ...
    for (int i = 0; i < dict_size; i++) {
        ...
        if (distance >= 1 && distance <= 2) {  // Distanza di modifica da 1 a 2
